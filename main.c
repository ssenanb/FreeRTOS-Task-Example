...
LedTaskParams Led1Params = {GPIOC, GPIO_PIN_8, 1000};
LedTaskParams Led2Params = {GPIOC, GPIO_PIN_9, 1000};
...
osThreadId_t LedTask1Handle, LedTask2Handle;
...
void StartUARTTask(void *argument){
	while(1){
		...
		sprintf(dizi,"index = %d\n",task_index++);
		HAL_UART_Transmit(&huart1, (uint8_t*)dizi, strlen(dizi), HAL_MAX_DELAY);
